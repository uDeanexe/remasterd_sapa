...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    ...
    <body class="font-sans antialiased text-gray-900 bg-gray-50 dark:bg-[#0b1220] dark:text-slate-100">
        ...
        <div
            ...
            x-data="{
                openKehadiran: {{ ((request()->routeIs('admin.presence.*') && !request()->routeIs('admin.presence.settings')) || request()->routeIs('admin.perizinan')) ? 'true' : 'false' }},
                openPekerjaan: {{ (request()->routeIs('jobs.*') || request()->routeIs('admin.clients.*') || request()->routeIs('worklog.*')) ? 'true' : 'false' }},
                openSettings: {{ (request()->routeIs('admin.settings') || request()->routeIs('admin.presence.settings')) ? 'true' : 'false' }},
