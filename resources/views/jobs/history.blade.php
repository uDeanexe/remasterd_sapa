            ...
            <div class="admin-page-header">
                ...
                <div class="admin-page-header-body">
                    <div>
                        ...
                        <p class="admin-subtitle">Pantau surat jalan, progres lapangan (step), feedback, dan komentar dalam satu halaman.</p>
                    </div>

                    @if(in_array($userRole, ['administrator', 'cs'], true))
                                                        ...
                                                        <div class="flex gap-3">
                                                            ...
                                                            <div class="min-w-0 flex-1 rounded-lg bg-slate-50 px-3 py-2">
                                                                <div class="flex flex-wrap items-center gap-2 text-xs text-slate-500">
                                                                    ...
                                                                    @if($userRole === 'administrator' || $comment->user_id === Auth::id())
